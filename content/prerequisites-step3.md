...
- Fill in the details for the name and the role that you copy ARN/take note earlier. i.e, **arn:aws:iam::** *<ACCOUNT-ID>* **:role/WSParticipantRole**. Provide the Role ARN in the connection details. This will be the role that grants the connector permissions to perform actions on resources.
...
- Share the connector to at least one user or group to share the connector with. Click Share to add the user to the list **i.e, : workshop-user**.
